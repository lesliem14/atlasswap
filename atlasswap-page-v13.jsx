...
const COINS = [
  ...
  { symbol: "BTC",   name: "Bitcoin",          color: "#F7931A", bg: "#1a0f00", icon: "₿", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/btc.png"  },
  { symbol: "ETH",   name: "Ethereum",         color: "#7B9EF0", bg: "#0a0f20", icon: "Ξ", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/eth.png"  },
  { symbol: "USDT",  name: "Tether",           color: "#26A17B", bg: "#001a13", icon: "T", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/usdt.png"  },
  { symbol: "BNB",   name: "BNB",              color: "#F3BA2F", bg: "#1a1200", icon: "◈", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/bnb.png"  },
  { symbol: "SOL",   name: "Solana",           color: "#9945FF", bg: "#0f0020", icon: "◎", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/sol.png"  },
  { symbol: "USDC",  name: "USD Coin",         color: "#2775CA", bg: "#001020", icon: "©", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/usdc.png"  },
  { symbol: "XRP",   name: "XRP",              color: "#00AAE4", bg: "#001a25", icon: "✕", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/xrp.png"  },
  { symbol: "DOGE",  name: "Dogecoin",         color: "#C2A633", bg: "#1a1500", icon: "Ð", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/doge.png"  },
  { symbol: "ADA",   name: "Cardano",          color: "#4B9CD3", bg: "#001525", icon: "₳", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/ada.png"  },
  { symbol: "TRX",   name: "TRON",             color: "#FF3D3D", bg: "#200000", icon: "◉", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/trx.png"  },
  // ── Tier 2: Layer 1 blockchains ───────────────────────────
  { symbol: "AVAX",  name: "Avalanche",        color: "#E84142", bg: "#200000", icon: "▲", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/avax.png"  },
  { symbol: "TON",   name: "Toncoin",          color: "#0098EA", bg: "#001525", icon: "◆", logoUrl: null  },
  { symbol: "DOT",   name: "Polkadot",         color: "#E6007A", bg: "#200015", icon: "●", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/dot.png"  },
  { symbol: "MATIC", name: "Polygon",          color: "#8247E5", bg: "#0d0025", icon: "⬟", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/matic.png"  },
  { symbol: "LTC",   name: "Litecoin",         color: "#A0A0A0", bg: "#111111", icon: "Ł", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/ltc.png"  },
  { symbol: "BCH",   name: "Bitcoin Cash",     color: "#8DC351", bg: "#0a1500", icon: "Ƀ", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/bch.png"  },
  { symbol: "ATOM",  name: "Cosmos",           color: "#6F7390", bg: "#0a0a15", icon: "⚛", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/atom.png"  },
  { symbol: "NEAR",  name: "NEAR Protocol",    color: "#00C08B", bg: "#001a13", icon: "Ⓝ", logoUrl: null  },
  { symbol: "FTM",   name: "Fantom",           color: "#1969FF", bg: "#000d25", icon: "⬡", logoUrl: null  },
  { symbol: "ALGO",  name: "Algorand",         color: "#FFFFFF", bg: "#101010", icon: "Ⓐ", logoUrl: null  },
  { symbol: "XLM",   name: "Stellar",          color: "#7D98B3", bg: "#0a1018", icon: "✦", logoUrl: null  },
  { symbol: "VET",   name: "VeChain",          color: "#15BDFF", bg: "#001525", icon: "✔", logoUrl: null  },
  { symbol: "HBAR",  name: "Hedera",           color: "#00ADED", bg: "#001520", icon: "ℏ", logoUrl: null  },
  { symbol: "ICP",   name: "Internet Computer",color: "#3B00B9", bg: "#0d0020", icon: "∞", logoUrl: null  },
  { symbol: "APT",   name: "Aptos",            color: "#BDCCDE", bg: "#101520", icon: "◎", logoUrl: null  },
  { symbol: "SUI",   name: "Sui",              color: "#6FBCF0", bg: "#001020", icon: "◉", logoUrl: null  },
  { symbol: "SEI",   name: "Sei",              color: "#FF4D4D", bg: "#200000", icon: "Ⓢ", logoUrl: null  },
  { symbol: "STX",   name: "Stacks",           color: "#FF5500", bg: "#1a0d00", icon: "₿", logoUrl: null  },
  { symbol: "EGLD",  name: "MultiversX",       color: "#23F7DD", bg: "#001a18", icon: "⬡", logoUrl: null  },
  { symbol: "FIL",   name: "Filecoin",         color: "#0090FF", bg: "#001525", icon: "⬡", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/fil.png"  },
  // ── Tier 3: DeFi tokens ───────────────────────────────────
  { symbol: "UNI",   name: "Uniswap",          color: "#FF007A", bg: "#200015", icon: "♦", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/uni.png"  },
  { symbol: "LINK",  name: "Chainlink",        color: "#375BD2", bg: "#000d25", icon: "⬡", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/link.png"  },
  { symbol: "AAVE",  name: "Aave",             color: "#B6509E", bg: "#1a001a", icon: "Ⓐ", logoUrl: null  },
  { symbol: "CRV",   name: "Curve DAO",        color: "#FF0000", bg: "#200000", icon: "©", logoUrl: null  },
  { symbol: "MKR",   name: "Maker",            color: "#1AAB9B", bg: "#001a18", icon: "Ⓜ", logoUrl: null  },
  { symbol: "SNX",   name: "Synthetix",        color: "#00D1FF", bg: "#001520", icon: "Ⓢ", logoUrl: null  },
  { symbol: "COMP",  name: "Compound",         color: "#00D395", bg: "#001a12", icon: "©", logoUrl: null  },
  { symbol: "LDO",   name: "Lido DAO",         color: "#F6C944", bg: "#1a1400", icon: "Ⓛ", logoUrl: null  },
  { symbol: "CAKE",  name: "PancakeSwap",      color: "#D1884F", bg: "#1a1000", icon: "🥞", logoUrl: null },
  { symbol: "1INCH", name: "1inch",            color: "#D82122", bg: "#200000", icon: "①", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/1inch.png"  },
  // ── Tier 4: Layer 2 & Scaling ─────────────────────────────
  { symbol: "ARB",   name: "Arbitrum",         color: "#28A0F0", bg: "#001520", icon: "Ⓐ", logoUrl: null  },
  { symbol: "OP",    name: "Optimism",         color: "#FF0420", bg: "#200000", icon: "Θ", logoUrl: null  },
  { symbol: "IMX",   name: "Immutable",        color: "#00D0FF", bg: "#001520", icon: "⬡", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/imx.png"  },
  { symbol: "STRK",  name: "Starknet",         color: "#EC796B", bg: "#1a0f0d", icon: "★", logoUrl: null  },
  { symbol: "MANTA", name: "Manta Network",    color: "#60A5FA", bg: "#001020", icon: "Ⓜ", logoUrl: null  },
  // ── Tier 5: Meme coins ────────────────────────────────────
  { symbol: "SHIB",  name: "Shiba Inu",        color: "#FFA409", bg: "#1a0f00", icon: "犬", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/shib.png" },
  { symbol: "PEPE",  name: "Pepe",             color: "#4CAF50", bg: "#001400", icon: "🐸", logoUrl: null },
  { symbol: "FLOKI", name: "Floki",            color: "#F0B90B", bg: "#1a1200", icon: "⚡", logoUrl: null },
  { symbol: "BONK",  name: "Bonk",             color: "#F97316", bg: "#1a0d00", icon: "🐕", logoUrl: null },
  { symbol: "WIF",   name: "dogwifhat",        color: "#E040FB", bg: "#1a0020", icon: "🎩", logoUrl: null },
  // ── Tier 6: Privacy coins ─────────────────────────────────
  { symbol: "XMR",   name: "Monero",           color: "#FF6600", bg: "#1a0a00", icon: "ɱ", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/xmr.png"  },
  { symbol: "ZEC",   name: "Zcash",            color: "#ECB244", bg: "#1a1200", icon: "ⓩ", logoUrl: null  },
  { symbol: "DASH",  name: "Dash",             color: "#008CE7", bg: "#001525", icon: "Đ", logoUrl: null  },
  { symbol: "XVG",   name: "Verge",            color: "#40C4FF", bg: "#001520", icon: "Ⓥ", logoUrl: null  },
  // ── Tier 7: Exchange & utility tokens ─────────────────────
  { symbol: "CRO",   name: "Cronos",           color: "#002D74", bg: "#000d25", icon: "©", logoUrl: null  },
  { symbol: "OKB",   name: "OKB",              color: "#2B60DC", bg: "#000d25", icon: "Ⓞ", logoUrl: null  },
  { symbol: "HT",    name: "Huobi Token",      color: "#1F72BB", bg: "#001020", icon: "Ⓗ", logoUrl: null  },
  // ── Tier 8: Cosmos ecosystem ──────────────────────────────
  { symbol: "OSMO",  name: "Osmosis",          color: "#750BBB", bg: "#0d0020", icon: "◎", logoUrl: null  },
  { symbol: "INJ",   name: "Injective",        color: "#00B2FF", bg: "#001a25", icon: "◈", logoUrl: null  },
  { symbol: "KAVA",  name: "Kava",             color: "#FF564F", bg: "#200000", icon: "Ⓚ", logoUrl: null  },
  { symbol: "JUNO",  name: "Juno",             color: "#F0827D", bg: "#200010", icon: "Ⓙ", logoUrl: null  },
  { symbol: "STARS", name: "Stargaze",         color: "#7C3AED", bg: "#0d0020", icon: "★", logoUrl: null  },
  // ── Tier 9: Stablecoins ───────────────────────────────────
  { symbol: "DAI",   name: "Dai",              color: "#F5AC37", bg: "#1a1100", icon: "◈", logoUrl: null  },
  { symbol: "BUSD",  name: "Binance USD",      color: "#F0B90B", bg: "#1a1200", icon: "Ƀ", logoUrl: null  },
  { symbol: "TUSD",  name: "TrueUSD",          color: "#002868", bg: "#000510", icon: "Ⓣ", logoUrl: null  },
  // ── Tier 10: Gaming & Metaverse ───────────────────────────
  { symbol: "SAND",  name: "The Sandbox",      color: "#04ADEF", bg: "#001520", icon: "⬡", logoUrl: null  },
  { symbol: "MANA",  name: "Decentraland",     color: "#FF2D55", bg: "#200010", icon: "Ⓜ", logoUrl: null  },
  { symbol: "AXS",   name: "Axie Infinity",    color: "#0055D5", bg: "#000d25", icon: "Ⓐ", logoUrl: null  },
  { symbol: "ENJ",   name: "Enjin Coin",       color: "#7866D5", bg: "#0a0d25", icon: "Ⓔ", logoUrl: null  },
  { symbol: "GALA",  name: "Gala",             color: "#0073FF", bg: "#001525", icon: "Ⓖ", logoUrl: null  },
  { symbol: "IMX",   name: "Immutable X",      color: "#00D0FF", bg: "#001520", icon: "⬡", logoUrl: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa/128/color/imx.png"  },
  // ── Tier 11: AI & Data tokens ─────────────────────────────
  { symbol: "FET",   name: "Fetch.ai",         color: "#1DA2FF", bg: "#001520", icon: "Ⓕ", logoUrl: null  },
  { symbol: "OCEAN", name: "Ocean Protocol",   color: "#1A6BFF", bg: "#000d25", icon: "Ⓞ", logoUrl: null  },
  { symbol: "RNDR",  name: "Render",           color: "#FF4D00", bg: "#1a0d00", icon: "Ⓡ", logoUrl: null  },
  { symbol: "WLD",   name: "Worldcoin",        color: "#191919", bg: "#0a0a0a", icon: "Ⓦ", logoUrl: null  },
  // ── Tier 12: Other high-demand ────────────────────────────
  { symbol: "GRT",   name: "The Graph",        color: "#5942C4", bg: "#0a0820", icon: "Ⓖ", logoUrl: null  },
  { symbol: "LRC",   name: "Loopring",         color: "#1C60FF", bg: "#000d25", icon: "Ⓛ", logoUrl: null  },
  { symbol: "CHZ",   name: "Chiliz",           color: "#CD0124", bg: "#200000", icon: "Ⓒ", logoUrl: null  },
  { symbol: "BAT",   name: "Basic Attn Token", color: "#FF5000", bg: "#1a1000", icon: "Ⓑ", logoUrl: null  },
  { symbol: "ZIL",   name: "Zilliqa",          color: "#49C1BF", bg: "#001a1a", icon: "Ⓩ", logoUrl: null  },
  { symbol: "IOTA",  name: "IOTA",             color: "#131F37", bg: "#0a0f1a", icon: "Ⓘ", logoUrl: null  },
  { symbol: "THETA", name: "Theta Network",    color: "#2AB8E6", bg: "#001520", icon: "Θ", logoUrl: null  },
  { symbol: "EOS",   name: "EOS",              color: "#000000", bg: "#0a0a0a", icon: "Ⓔ", logoUrl: null  },
  { symbol: "XTZ",   name: "Tezos",            color: "#2C7DF7", bg: "#001020", icon: "ꜩ", logoUrl: null  },
  { symbol: "XEM",   name: "NEM",              color: "#67B2E8", bg: "#001520", icon: "Ⓝ", logoUrl: null  },
  { symbol: "WAVES", name: "Waves",            color: "#0155FF", bg: "#001525", icon: "Ⓦ", logoUrl: null  },
  { symbol: "QTUM",  name: "Qtum",             color: "#2895D8", bg: "#001520", icon: "Ⓠ", logoUrl: null  },
  { symbol: "KCS",   name: "KuCoin Token",     color: "#24AE8F", bg: "#001a15", icon: "Ⓚ", logoUrl: null  },
  { symbol: "ROSE",  name: "Oasis Network",    color: "#0092F6", bg: "#001525", icon: "Ⓡ", logoUrl: null  },
  { symbol: "CFX",   name: "Conflux",          color: "#15C0E6", bg: "#001520", icon: "Ⓒ", logoUrl: null  },
  { symbol: "KSM",   name: "Kusama",           color: "#E8026D", bg: "#200015", icon: "Ⓚ", logoUrl: null  },
  { symbol: "ZEN",   name: "Horizen",          color: "#041742", bg: "#000510", icon: "Ⓩ", logoUrl: null  },
  { symbol: "DCR",   name: "Decred",           color: "#2ED8A3", bg: "#001a14", icon: "Ð", logoUrl: null  },
  { symbol: "RVN",   name: "Ravencoin",        color: "#384182", bg: "#0a0d1a", icon: "Ⓡ", logoUrl: null  },
  { symbol: "SC",    name: "Siacoin",          color: "#1ED660", bg: "#001a0d", icon: "Ⓢ", logoUrl: null  },
  { symbol: "DGB",   name: "DigiByte",         color: "#0066CC", bg: "#001020", icon: "Ð", logoUrl: null  },
];
// Remove duplicate IMX entry; keep explicit logoUrl, drop legacy text icon
